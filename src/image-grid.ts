...
/** layout for grid of graphics for print & punch */
export type GridSpec = LayoutSpec & {
  /** pixel width of png template */
  width: number,  // canvas size
  /** pixel height of png template */
  height: number, // canvas size
...
export class PageMaker {
  ...
  /** stage for addObjects */
  stage!: Stage;
  /** draw objects on this canvas, retain in pageSpec.canvas */
  canvas!: HTMLCanvasElement;
